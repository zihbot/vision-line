...
export class BaseAPI {
    ...
    private rxjsRequest = (params: RequestArgs): Observable<AjaxResponse<any>> =>
        of(params).pipe(
            map((request) => {
...
export interface RawAjaxResponse<T> extends AjaxResponse<T> {
    response: T;
}
...
export interface ResponseArgs extends AjaxResponse<any> {}
